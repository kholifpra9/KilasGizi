    ...
    <>
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4 animate-in fade-in duration-200">
          <div className="w-full max-w-sm rounded-3xl border border-kg-tan bg-card p-6 shadow-2xl animate-in zoom-in-95 duration-200 space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-kg-coral/10 text-xl">
                🚪
              </div>
              <div>
                <h3 className="font-display text-base font-bold text-kg-ink">Konfirmasi Keluar</h3>
                <p className="text-xs text-kg-ink/60">Apakah Anda yakin ingin keluar dari akun KilasGizi?</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <button
                ...
                className="rounded-full border border-kg-tan px-4 py-2 text-xs font-semibold text-kg-ink hover:bg-kg-tan/30 transition-colors"
              >
                Batal
              </button>
              <button
                onClick={confirmLogout}
                className="rounded-full bg-kg-coral px-5 py-2 text-xs font-bold text-white shadow-sm hover:opacity-90 transition-opacity"
              >
                Ya, Keluar
              </button>
            </div>
